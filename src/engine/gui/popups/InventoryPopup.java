...
public class InventoryPopup {
	...
	public void init(GuiManager guiManager, Window window, HashMap<String, Mesh> meshTypesMap) {
		...
		try {
	    	...
	    	// inventory
	    	TextureAtlas texturePanelInventory = new TextureAtlas(Config.RESOURCES_DIR +  "/textures/window.png");
	    	...
	    	TextureAtlas textureBtnStairs = new TextureAtlas(Config.RESOURCES_DIR +  "/textures/button_cube_stairs.png");
	    	...
	    	TextureAtlas textureBtnStairsCorner = new TextureAtlas(Config.RESOURCES_DIR +  "/textures/button_cube_stairs_corner.png");
	    	...
	    	TextureAtlas textureBtnStairsCornerInner = new TextureAtlas(Config.RESOURCES_DIR +  "/textures/button_cube_stairs_corner_inner.png");
	    	...
	    	TextureAtlas textureBtnOakWood = new TextureAtlas(Config.RESOURCES_DIR +  "/textures/button_cube_oakwood.png");
	    	...
	    	TextureAtlas textureBtnWood = new TextureAtlas(Config.RESOURCES_DIR +  "/textures/button_cube_wood.png");
	    	...
	    	TextureAtlas textureBtnCobble = new TextureAtlas(Config.RESOURCES_DIR +  "/textures/button_cube_cobble.png");
	    	...
	    	TextureAtlas textureBtnGrass = new TextureAtlas(Config.RESOURCES_DIR +  "/textures/button_cube_grass.png");
	    	...
	    	TextureAtlas textureBtnGround = new TextureAtlas(Config.RESOURCES_DIR +  "/textures/button_cube_ground.png");
	    	...
	    	TextureAtlas textureBtnWater = new TextureAtlas(Config.RESOURCES_DIR +  "/textures/button_cube_water.png");
	    	...
	    	TextureAtlas textureBtnGlass = new TextureAtlas(Config.RESOURCES_DIR +  "/textures/button_cube_glass.png");
	    	...
	    	TextureAtlas textureBtnTreetop = new TextureAtlas(Config.RESOURCES_DIR +  "/textures/button_cube_treetop.png");
	    	...
	    	TextureAtlas textureBtnLava = new TextureAtlas(Config.RESOURCES_DIR +  "/textures/button_cube_lava.png");
