...
public class WaterMeshShader extends ShaderProgram {
	...
	private static final String VERTEX_SHADER = Config.RESOURCES_DIR + "/ThinMatrix/shaders/waterVertex.glsl";
	private static final String FRAGMENT_SHADER = Config.RESOURCES_DIR + "/ThinMatrix/shaders/waterFragment.glsl";
