...
import engine.tm.openglObjects.Query;
...
public class FlareRenderer {
	 ...
	 *            at.
	 */
	public void render(Vector2f sunScreenCoords, FlareTexture[] flares, float brightness) {
		prepare(brightness);
	...
	private void renderFlare(FlareTexture flare) {
		...
		float yScale = xScale * (float) Window.width / Window.height;
