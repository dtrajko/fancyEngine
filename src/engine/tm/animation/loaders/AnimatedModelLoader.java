...
import engine.tm.colladaParser.dataStructures.JointData;
...
public class AnimatedModelLoader {
	...
	public static AnimatedModel loadEntity(MyFile modelFile, MyFile textureFile) {
		AnimatedModelData entityData = ColladaLoader.loadColladaModel(modelFile, WorldSettings.MAX_WEIGHTS);
