...
import engine.tm2.opengl.DataStoring;
import engine.tm2.opengl.Vao;
import engine.tm2.opengl.VaoLoader;
...
public class WaterGenerator {
	 ...
	 */
	public static WaterMesh generate(int gridCount, float height) {
		...
		return new WaterMesh(vao, totalVertexCount, height);
	}
	...
	private static byte[] getIndicators(int currentVertex, Vector2f[] vertexPositions, int vertex1, int vertex2) {
		...
		Vector2f offset1 = vertex1Pos.sub(currentVertexPos);
		Vector2f offset2 = vertex2Pos.sub(currentVertexPos);		
